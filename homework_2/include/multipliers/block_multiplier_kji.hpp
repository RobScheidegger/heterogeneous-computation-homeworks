...
class BlockingMultiplierKJI : public IMatrixMultiplier {
   public:
    BlockingMultiplierKJI(const uint32_t block_size_i, const uint32_t block_size_j, const uint32_t block_size_k)
